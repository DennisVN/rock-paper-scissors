...
function convert(word){
	...
	if(word === "rock") return '🧱';
    if(word === "lizard") return '🦎';
    if(word === "spock") return '🖖';
	return '✂️'
}
function game(UserChoice){
	...
	if(UserChoice === "paper" && ComChoice === "rock" || UserChoice === "rock" && ComChoice === "scissors" || UserChoice === "scissors" && ComChoice === "paper" || UserChoice === "lizard" && ComChoice === "rock" || UserChoice === "lizard" && ComChoice === "spock" || UserChoice === "lizard" && ComChoice === "paper" || UserChoice === "spock" && ComChoice === "paper" || UserChoice === "scissors" && ComChoice === "spock" || UserChoice === "scissors" && ComChoice === "lizard"){
		win(UserChoice);
	}
